      ...
      {isOpenChooseCardScreen ? (
        <>
          ...
          <View style={styles.body}>
            <Label>Перевод на другую карду</Label>
        ...
        <>
          ...
          <View style={styles.body}>
            <Label>Перевод на другую карту</Label>
            <View style={styles.headerInput}>
              <Input state={sum} setState={setSum} placeholder="Введите сумму перевода..." keyboardType="decimal-pad" />
            </View>
            <View style={styles.transferBody}>
              ...
              <TouchableOpacity onPress={onChooseCardPressHandler} activeOpacity={AppConstants.ActiveOpacity}>
                <View style={styles.chooseCardButton}>
                  <Text style={styles.chooseCardButtonText}>Выбрать карту</Text>
                </View>
              </TouchableOpacity>
              {selectedCard?.id && (
